...
expert <- readxl::read_excel("Lotta_Files/mountain_experts_validation.xlsx", sheet = 1)
...
expert_csv <- expert_mountain %>%
  st_drop_geometry()
write.csv(expert_csv, "mountain_experts_validation_modified.csv")
